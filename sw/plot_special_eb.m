function [rmse_log,p_out] = plot_special_eb(x,z,std_x,std_z,order,ii,fit_visible)
...
errorbar(x,z,std_z,std_z,std_x,std_x,pointer(ii),'color',colors(ii,:))
hold on
p_out = [];
